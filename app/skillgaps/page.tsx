...
export default function SkillGapsPage() {
  ...
  return <AppShell><div className="mx-auto flex max-w-[1240px] flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8"><PageHeader eyebrow="Outcome intelligence" title="Skill gap intelligence" description="Which reported skill gaps are actually costing learners jobs and wages?" />
